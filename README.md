...
This plugin is essentially a Maven wrapper for the packaging tool, called [javapackager](https://docs.oracle.com/javase/9/tools/javapackager.htm), that comes with JavaFX.
